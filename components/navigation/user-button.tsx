            ...
            theme && (
              <DropdownMenuItem>
                <div
                  ...
                  <div className='flex relative mb-3 mr-8'>
                    <Sun
                    ...
                    />
                    <Moon
                      className='absolute scale-0group-hover:text-blue-400  scale-0 rotate-90 dark:rotate-0  dark:scale-100 transition-all ease-in-out duration-750'
                      size={14}
                    />
                  </div>
                  <div>
                    <p className='dark:text-blue-400 mr-3 text-secondary-foreground/75 text-yellow-600'>{theme[0].toUpperCase() + theme.slice(1)} Mode</p>
                  </div>
